"""Tests for path safety, atomic file writes, hashing, and dataset staging."""
...
def test_safe_path_valid(tmp_path):
    # Standard subdirectories and files
...
def test_safe_path_symlink_escape(tmp_path):
    ...
    # Symlink resolving outside or being a symlink must be rejected
