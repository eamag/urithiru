"""One GenAI transport for every runtime; prior and merge calls keep the original prompts."""
...
class LLM:
    """Application default credentials on Google Cloud; a Vertex express key everywhere else."""
    ...
    def __init__(self, config: Config, seed: int):
        ...
        # An express-mode key is global; only a credentialed client can pin the embedding region.
